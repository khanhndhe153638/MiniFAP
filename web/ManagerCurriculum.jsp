<%-- 
    Document   : ManagerCurriculum
    Created on : Jul 9, 2021, 10:55:00 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <nav style="margin-bottom: 20px; width: 159%">
            ...
            <div class="sidebar" style="width: 80%">
                <div class="box">
                    ...
                    <table style="padding: 0">
                        <tr>
                        <th style="height: 50px; padding-right: 0px;">Subject Code</th>
                            <th>Subject Name</th>
                            <th>Term No</th>
                            <th>Actions</th>
                            </tr>
